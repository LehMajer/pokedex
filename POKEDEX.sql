...
INSERT INTO pokemons (Nome, Tipo1, Tipo2, Total, HP, ATK, DFS, SPATK, SPDFS, SPEED, GERACAO, LEGENDARY) 
VALUES ('Bulbasaur','Grass','Poison',318,45,49,49,65,65,45,1,FALSE),
...
('BlastoiseMega Blastoise','Water',NULL,630,79,103,120,135,115,78,1,FALSE),
...
('AlakazamMega Alakazam','Psychic',NULL,590,55,50,65,175,95,150,1,FALSE),
...
('KangaskhanMega Kangaskhan','Normal',NULL,590,105,125,100,60,100,100,1,FALSE),
...
('MewtwoMega Mewtwo Y','Psychic',NULL,780,106,150,70,194,120,140,1,TRUE),
...
('AggronMega Aggron','Steel',NULL,630,70,140,230,60,80,50,3,FALSE),
...
('ManectricMega Manectric','Electric',NULL,575,70,75,80,135,80,135,3,FALSE),
...
('BanetteMega Banette','Ghost',NULL,555,64,165,75,93,83,75,3,FALSE),
...
('AbsolMega Absol','Dark',NULL,565,65,150,60,115,60,115,3,FALSE),
...
('GlalieMega Glalie','Ice',NULL,580,80,120,80,120,80,100,3,FALSE),
...
('KyogrePrimal Kyogre','Water',NULL,770,100,150,90,180,160,90,3,TRUE),
...
('DeoxysNormal Forme','Psychic',NULL,600,50,150,50,150,50,150,3,TRUE),
('DeoxysAttack Forme','Psychic',NULL,600,50,180,20,180,20,150,3,TRUE),
('DeoxysDefense Forme','Psychic',NULL,600,50,70,160,70,160,90,3,TRUE),
('DeoxysSpeed Forme','Psychic',NULL,600,50,95,90,95,90,180,3,TRUE),
('Turtwig','Grass',NULL,318,55,68,64,45,55,31,4,FALSE),
('Grotle','Grass',NULL,405,75,89,85,55,65,36,4,FALSE),
('Torterra','Grass','Ground',525,95,109,105,75,85,56,4,FALSE),
('Chimchar','Fire',NULL,309,44,58,44,58,44,61,4,FALSE),
('Monferno','Fire','Fighting',405,64,78,52,78,52,81,4,FALSE),
('Infernape','Fire','Fighting',534,76,104,71,104,71,108,4,FALSE),
('Piplup','Water',NULL,314,53,51,53,61,56,40,4,FALSE),
('Prinplup','Water',NULL,405,64,66,68,81,76,50,4,FALSE),
...
('Bidoof','Normal',NULL,250,59,45,40,35,40,31,4,FALSE),
('Bibarel','Normal','Water',410,79,85,60,55,60,71,4,FALSE),
('Kricketot','Bug',NULL,194,37,25,41,25,41,25,4,FALSE),
('Kricketune','Bug',NULL,384,77,85,51,55,51,65,4,FALSE),
('Shinx','Electric',NULL,263,45,65,34,40,34,45,4,FALSE),
('Luxio','Electric',NULL,363,60,85,49,60,49,60,4,FALSE),
('Luxray','Electric',NULL,523,80,120,79,95,79,70,4,FALSE),
('Budew','Grass','Poison',280,40,30,35,50,70,55,4,FALSE),
('Roserade','Grass','Poison',515,60,70,65,125,105,90,4,FALSE),
('Cranidos','Rock',NULL,350,67,125,40,30,30,58,4,FALSE),
('Rampardos','Rock',NULL,495,97,165,60,65,50,58,4,FALSE),
('Shieldon','Rock','Steel',350,30,42,118,42,88,30,4,FALSE),
('Bastiodon','Rock','Steel',495,60,52,168,47,138,30,4,FALSE),
('Burmy','Bug',NULL,224,40,29,45,29,45,36,4,FALSE),
...
('Pachirisu','Electric',NULL,405,60,45,70,45,90,95,4,FALSE),
('Buizel','Water',NULL,330,55,65,35,60,30,85,4,FALSE),
('Floatzel','Water',NULL,495,85,105,55,85,50,115,4,FALSE),
('Cherubi','Grass',NULL,275,45,35,45,62,53,35,4,FALSE),
('Cherrim','Grass',NULL,450,70,60,70,87,78,85,4,FALSE),
('Shellos','Water',NULL,325,76,48,48,57,62,34,4,FALSE),
('Gastrodon','Water','Ground',475,111,83,68,92,82,39,4,FALSE),
('Ambipom','Normal',NULL,482,75,100,66,60,66,115,4,FALSE),
('Drifloon','Ghost','Flying',348,90,50,34,60,44,70,4,FALSE),
('Drifblim','Ghost','Flying',498,150,80,44,90,54,80,4,FALSE),
('Buneary','Normal',NULL,350,55,66,44,44,56,85,4,FALSE),
('Lopunny','Normal',NULL,480,65,76,84,54,96,105,4,FALSE),
('LopunnyMega Lopunny','Normal','Fighting',580,65,136,94,54,96,135,4,FALSE),
('Mismagius','Ghost',NULL,495,60,60,60,105,105,105,4,FALSE),
('Honchkrow','Dark','Flying',505,100,125,52,105,52,71,4,FALSE),
('Glameow','Normal',NULL,310,49,55,42,42,37,85,4,FALSE),
('Purugly','Normal',NULL,452,71,82,64,64,59,112,4,FALSE),
('Chingling','Psychic',NULL,285,45,30,50,65,50,45,4,FALSE),
...
('Bonsly','Rock',NULL,290,50,80,95,10,45,10,4,FALSE),
('Mime Jr.','Psychic','Fairy',310,20,25,45,70,90,60,4,FALSE),
('Happiny','Normal',NULL,220,100,5,5,15,65,30,4,FALSE),
...
('Munchlax','Normal',NULL,390,135,85,40,40,85,5,4,FALSE),
('Riolu','Fighting',NULL,285,40,70,40,35,40,60,4,FALSE),
...
('Hippopotas','Ground',NULL,330,68,72,78,38,42,32,4,FALSE),
('Hippowdon','Ground',NULL,525,108,112,118,68,72,47,4,FALSE),
...
('Carnivine','Grass',NULL,454,74,100,72,90,72,46,4,FALSE),
('Finneon','Water',NULL,330,49,49,56,49,61,66,4,FALSE),
('Lumineon','Water',NULL,460,69,69,76,69,86,91,4,FALSE),
...
('Lickilicky','Normal',NULL,515,110,85,95,80,95,50,4,FALSE),
('Rhyperior','Ground','Rock',535,115,140,130,55,55,40,4,FALSE),
('Tangrowth','Grass',NULL,535,100,100,125,110,50,50,4,FALSE),
('Electivire','Electric',NULL,540,75,123,67,95,85,95,4,FALSE),
('Magmortar','Fire',NULL,540,75,95,67,125,95,83,4,FALSE),
('Togekiss','Fairy','Flying',545,85,50,95,120,115,80,4,FALSE),
('Yanmega','Bug','Flying',515,86,76,86,116,56,95,4,FALSE),
('Leafeon','Grass',NULL,525,65,110,130,60,65,95,4,FALSE),
('Glaceon','Ice',NULL,525,65,60,110,130,95,65,4,FALSE),
('Gliscor','Ground','Flying',510,75,95,125,45,75,95,4,FALSE),
('Mamoswine','Ice','Ground',530,110,130,80,70,60,80,4,FALSE),
('Porygon-Z','Normal',NULL,535,85,80,70,135,75,90,4,FALSE),
...
('Dusknoir','Ghost',NULL,525,45,100,135,65,135,45,4,FALSE),
...
('Uxie','Psychic',NULL,580,75,75,130,75,130,95,4,TRUE),
('Mesprit','Psychic',NULL,580,80,105,105,105,105,80,4,TRUE),
('Azelf','Psychic',NULL,580,75,125,70,125,70,115,4,TRUE),
...
('Regigigas','Normal',NULL,670,110,160,110,80,110,100,4,TRUE),
...
('Cresselia','Psychic',NULL,600,120,70,120,75,130,85,4,FALSE),
('Phione','Water',NULL,480,80,80,80,80,80,80,4,FALSE),
('Manaphy','Water',NULL,600,100,100,100,100,100,100,4,FALSE),
('Darkrai','Dark',NULL,600,70,90,90,135,90,125,4,TRUE),
('ShayminLand Forme','Grass',NULL,600,100,100,100,100,100,100,4,TRUE),
('ShayminSky Forme','Grass','Flying',600,100,103,75,120,75,127,4,TRUE),
('Arceus','Normal',NULL,720,120,120,120,120,120,120,4,TRUE),
('Victini','Psychic','Fire',600,100,100,100,100,100,100,5,TRUE),
('Snivy','Grass',NULL,308,45,45,55,45,55,63,5,FALSE),
('Servine','Grass',NULL,413,60,60,75,60,75,83,5,FALSE),
('Serperior','Grass',NULL,528,75,75,95,75,95,113,5,FALSE),
('Tepig','Fire',NULL,308,65,63,45,45,45,45,5,FALSE),
('Pignite','Fire','Fighting',418,90,93,55,70,55,55,5,FALSE),
('Emboar','Fire','Fighting',528,110,123,65,100,65,65,5,FALSE),
('Oshawott','Water',NULL,308,55,55,45,63,45,45,5,FALSE),
('Dewott','Water',NULL,413,75,75,60,83,60,60,5,FALSE),
('Samurott','Water',NULL,528,95,100,85,108,70,70,5,FALSE),
('Patrat','Normal',NULL,255,45,55,39,35,39,42,5,FALSE),
('Watchog','Normal',NULL,420,60,85,69,60,69,77,5,FALSE),
('Lillipup','Normal',NULL,275,45,60,45,25,45,55,5,FALSE),
('Herdier','Normal',NULL,370,65,80,65,35,65,60,5,FALSE),
('Stoutland','Normal',NULL,500,85,110,90,45,90,80,5,FALSE),
('Purrloin','Dark',NULL,281,41,50,37,50,37,66,5,FALSE),
('Liepard','Dark',NULL,446,64,88,50,88,50,106,5,FALSE),
('Pansage','Grass',NULL,316,50,53,48,53,48,64,5,FALSE),
('Simisage','Grass',NULL,498,75,98,63,98,63,101,5,FALSE),
('Pansear','Fire',NULL,316,50,53,48,53,48,64,5,FALSE),
('Simisear','Fire',NULL,498,75,98,63,98,63,101,5,FALSE),
('Panpour','Water',NULL,316,50,53,48,53,48,64,5,FALSE),
('Simipour','Water',NULL,498,75,98,63,98,63,101,5,FALSE),
('Munna','Psychic',NULL,292,76,25,45,67,55,24,5,FALSE),
('Musharna','Psychic',NULL,487,116,55,85,107,95,29,5,FALSE),
...
('Blitzle','Electric',NULL,295,45,60,32,50,32,76,5,FALSE),
('Zebstrika','Electric',NULL,497,75,100,63,80,63,116,5,FALSE),
('Roggenrola','Rock',NULL,280,55,75,85,25,25,15,5,FALSE),
('Boldore','Rock',NULL,390,70,105,105,50,40,20,5,FALSE),
('Gigalith','Rock',NULL,515,85,135,130,60,80,25,5,FALSE),
('Woobat','Psychic','Flying',313,55,45,43,55,43,72,5,FALSE),
('Swoobat','Psychic','Flying',425,67,57,55,77,55,114,5,FALSE),
('Drilbur','Ground',NULL,328,60,85,40,30,45,68,5,FALSE),
('Excadrill','Ground','Steel',508,110,135,60,50,65,88,5,FALSE),
('Audino','Normal',NULL,445,103,60,86,60,86,50,5,FALSE),
('AudinoMega Audino','Normal','Fairy',545,103,60,126,80,126,50,5,FALSE),
('Timburr','Fighting',NULL,305,75,80,55,25,35,35,5,FALSE),
('Gurdurr','Fighting',NULL,405,85,105,85,40,50,40,5,FALSE),
('Conkeldurr','Fighting',NULL,505,105,140,95,55,65,45,5,FALSE),
('Tympole','Water',NULL,294,50,50,40,50,40,64,5,FALSE),
('Palpitoad','Water','Ground',384,75,65,55,65,55,69,5,FALSE),
('Seismitoad','Water','Ground',509,105,95,75,85,75,74,5,FALSE),
('Throh','Fighting',NULL,465,120,100,85,30,85,45,5,FALSE),
('Sawk','Fighting',NULL,465,75,125,75,30,75,85,5,FALSE),
...
('Petilil','Grass',NULL,280,45,35,50,70,50,30,5,FALSE),
('Lilligant','Grass',NULL,480,70,60,75,110,75,90,5,FALSE),
('Basculin','Water',NULL,460,70,92,65,80,55,98,5,FALSE),
...
('Darumaka','Fire',NULL,315,70,90,45,15,45,50,5,FALSE),
('DarmanitanStandard Mode','Fire',NULL,480,105,140,55,30,55,95,5,FALSE),
('DarmanitanZen Mode','Fire','Psychic',540,105,30,105,140,105,55,5,FALSE),
('Maractus','Grass',NULL,461,75,86,67,106,67,60,5,FALSE),
...
('Yamask','Ghost',NULL,303,38,30,85,55,65,30,5,FALSE),
('Cofagrigus','Ghost',NULL,483,58,50,145,95,105,30,5,FALSE),
...
('Trubbish','Poison',NULL,329,50,50,62,40,62,65,5,FALSE),
('Garbodor','Poison',NULL,474,80,95,82,60,82,75,5,FALSE),
('Zorua','Dark',NULL,330,40,65,40,80,40,65,5,FALSE),
('Zoroark','Dark',NULL,510,60,105,60,120,60,105,5,FALSE),
('Minccino','Normal',NULL,300,55,50,40,40,40,75,5,FALSE),
('Cinccino','Normal',NULL,470,75,95,60,65,60,115,5,FALSE),
('Gothita','Psychic',NULL,290,45,30,50,55,65,45,5,FALSE),
('Gothorita','Psychic',NULL,390,60,45,70,75,85,55,5,FALSE),
('Gothitelle','Psychic',NULL,490,70,55,95,95,110,65,5,FALSE),
('Solosis','Psychic',NULL,290,45,30,40,105,50,20,5,FALSE),
('Duosion','Psychic',NULL,370,65,40,50,125,60,30,5,FALSE),
('Reuniclus','Psychic',NULL,490,110,65,75,125,85,30,5,FALSE),
('Ducklett','Water','Flying',305,62,44,50,44,50,55,5,FALSE),
('Swanna','Water','Flying',473,75,87,63,87,63,98,5,FALSE),
('Vanillite','Ice',NULL,305,36,50,50,65,60,44,5,FALSE),
('Vanillish','Ice',NULL,395,51,65,65,80,75,59,5,FALSE),
('Vanilluxe','Ice',NULL,535,71,95,85,110,95,79,5,FALSE),
...
('Karrablast','Bug',NULL,315,50,75,45,40,45,60,5,FALSE),
...
('Alomomola','Water',NULL,470,165,75,80,40,45,65,5,FALSE),
...
('Klink','Steel',NULL,300,40,55,70,45,60,30,5,FALSE),
('Klang','Steel',NULL,440,60,80,95,70,85,50,5,FALSE),
('Klinklang','Steel',NULL,520,60,100,115,70,85,90,5,FALSE),
('Tynamo','Electric',NULL,275,35,55,40,45,40,60,5,FALSE),
('Eelektrik','Electric',NULL,405,65,85,70,75,70,40,5,FALSE),
('Eelektross','Electric',NULL,515,85,115,80,105,80,50,5,FALSE),
('Elgyem','Psychic',NULL,335,55,55,55,85,55,30,5,FALSE),
('Beheeyem','Psychic',NULL,485,75,75,75,125,95,40,5,FALSE),
...
('Axew','Dragon',NULL,320,46,87,60,30,40,57,5,FALSE),
('Fraxure','Dragon',NULL,410,66,117,70,40,50,67,5,FALSE),
('Haxorus','Dragon',NULL,540,76,147,90,60,70,97,5,FALSE),
('Cubchoo','Ice',NULL,305,55,70,40,60,40,40,5,FALSE),
('Beartic','Ice',NULL,485,95,110,80,70,80,50,5,FALSE),
('Cryogonal','Ice',NULL,485,70,50,30,95,135,105,5,FALSE),
('Shelmet','Bug',NULL,305,50,40,85,40,65,25,5,FALSE),
('Accelgor','Bug',NULL,495,80,70,40,100,60,145,5,FALSE),
('Stunfisk','Ground','Electric',471,109,66,84,81,99,32,5,FALSE),
('Mienfoo','Fighting',NULL,350,45,85,50,55,50,65,5,FALSE),
('Mienshao','Fighting',NULL,510,65,125,60,95,60,105,5,FALSE),
('Druddigon','Dragon',NULL,485,77,120,90,60,90,48,5,FALSE),
...
('Bouffalant','Normal',NULL,490,95,110,95,40,95,55,5,FALSE),
...
('Heatmor','Fire',NULL,484,85,97,66,105,66,65,5,FALSE),
...
('TornadusIncarnate Forme','Flying',NULL,580,79,115,70,125,80,111,5,TRUE),
('TornadusTherian Forme','Flying',NULL,580,79,100,80,110,90,121,5,TRUE),
...
('Chespin','Grass',NULL,313,56,61,65,48,45,38,6,FALSE),
('Quilladin','Grass',NULL,405,61,78,95,56,58,57,6,FALSE),
('Chesnaught','Grass','Fighting',530,88,107,122,74,75,64,6,FALSE),
('Fennekin','Fire',NULL,307,40,45,40,62,60,60,6,FALSE),
('Braixen','Fire',NULL,409,59,59,58,90,70,73,6,FALSE),
('Delphox','Fire','Psychic',534,75,69,72,114,100,104,6,FALSE),
('Froakie','Water',NULL,314,41,56,40,62,44,71,6,FALSE),
('Frogadier','Water',NULL,405,54,63,52,83,56,97,6,FALSE),
('Greninja','Water','Dark',530,72,95,67,103,71,122,6,FALSE),
('Bunnelby','Normal',NULL,237,38,36,38,32,36,57,6,FALSE),
...
('ScatterBug','Bug',NULL,200,38,35,40,27,25,35,6,FALSE),
('Spewpa','Bug',NULL,213,45,22,60,27,30,29,6,FALSE),
...
('Flabébé','Fairy',NULL,303,44,38,39,61,79,42,6,FALSE),
('Floette','Fairy',NULL,371,54,45,47,75,98,52,6,FALSE),
('Florges','Fairy',NULL,552,78,65,68,112,154,75,6,FALSE),
('Skiddo','Grass',NULL,350,66,65,48,62,57,52,6,FALSE),
('Gogoat','Grass',NULL,531,123,100,62,97,81,68,6,FALSE),
('Pancham','Fighting',NULL,348,67,82,62,46,48,43,6,FALSE),
('Pangoro','Fighting','Dark',495,95,124,78,69,71,58,6,FALSE),
('Furfrou','Normal',NULL,472,75,80,60,65,90,102,6,FALSE),
('Espurr','Psychic',NULL,355,62,48,54,63,60,68,6,FALSE),
('MeowsticMale','Psychic',NULL,466,74,48,76,83,81,104,6,FALSE),
('MeowsticFemale','Psychic',NULL,466,74,48,76,83,81,104,6,FALSE),
...
('Spritzee','Fairy',NULL,341,78,52,60,63,65,23,6,FALSE),
('Aromatisse','Fairy',NULL,462,101,72,72,99,89,29,6,FALSE),
('Swirlix','Fairy',NULL,341,62,48,66,59,57,49,6,FALSE),
('Slurpuff','Fairy',NULL,480,82,80,86,85,75,72,6,FALSE),
...
('Clauncher','Water',NULL,330,50,53,62,58,63,44,6,FALSE),
('Clawitzer','Water',NULL,500,71,73,88,120,89,59,6,FALSE),
...
('Sylveon','Fairy',NULL,525,95,65,65,110,130,60,6,FALSE),
...
('Goomy','Dragon',NULL,300,45,50,35,55,75,40,6,FALSE),
('Sliggoo','Dragon',NULL,452,68,75,53,83,113,60,6,FALSE),
('Goodra','Dragon',NULL,600,90,100,70,110,150,80,6,FALSE),
...
('Bergmite','Ice',NULL,304,55,69,85,32,35,28,6,FALSE),
('Avalugg','Ice',NULL,514,95,117,184,44,46,28,6,FALSE),
('Noibat','Flying','Dragon',245,40,30,35,45,40,55,6,FALSE),
('Noivern','Flying','Dragon',535,85,70,80,97,80,123,6,FALSE),
('Xerneas','Fairy',NULL,680,126,131,95,131,98,99,6,TRUE),
